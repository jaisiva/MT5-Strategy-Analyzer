...
Excel report writer for L Pattern strategies.
...
class LPatternReportWriter:
    """
    Excel writer for L Pattern strategies.
    """
    ...
    def _write_summary(
        ...
        builder.write_table(
            ...
            title="L Pattern Summary",

            data=[

                {
                    "Strategy": result.strategy_name,
                    "Pattern": result.statistics.pattern,
    ...
    def _write_trades(
        ...
        sheet = workbook.add_sheet("Trades")
